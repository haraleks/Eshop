...
from shop.views import (ProductViewSet, CategoryViewSet, ProductsCompareViewSet,
                        WishListViewSet, CartsViewSet, PositionProductsViewSet, SendPayCarts)
...
urlpatterns = [
    ...
    path('carts/', CartsViewSet.as_view({'get': 'list'}), name='carts'),
    path('carts/<int:pk>/', CartsViewSet.as_view({'delete': 'destroy'}), name='carts_pk'),
